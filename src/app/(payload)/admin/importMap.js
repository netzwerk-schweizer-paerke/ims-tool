...
import { ActivityLandscapeLink as ActivityLandscapeLink_14 } from 'src/admin-components/activity/activity-landscape-link';
import { OrganisationSelect as OrganisationSelect_15 } from 'src/admin-components/organisation-select';
import { FlowBlockView as FlowBlockView_16 } from 'src/admin-components/flow';
import { ListBlockView as ListBlockView_17 } from 'src/admin-components/list';
import { ActivityBlockView as ActivityBlockView_18 } from 'src/admin-components/activity/view';
import { ActivitiesView as ActivitiesView_19 } from 'src/admin-components/activity/overview';
...
export const importMap = {
  ...
  'src/admin-components/activity/activity-landscape-link#ActivityLandscapeLink':
    ActivityLandscapeLink_14,
  'src/admin-components/organisation-select#OrganisationSelect': OrganisationSelect_15,
  'src/admin-components/flow#FlowBlockView': FlowBlockView_16,
  'src/admin-components/list#ListBlockView': ListBlockView_17,
  'src/admin-components/activity/view#ActivityBlockView': ActivityBlockView_18,
  'src/admin-components/activity/overview#ActivitiesView': ActivitiesView_19,
};
