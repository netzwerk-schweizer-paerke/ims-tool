export const de = {
  ...
  landscapeSearch: {
    error: 'Die Suche konnte nicht geladen werden. Bitte erneut versuchen.',
    kindActivity: 'Aktivität',
    kindBlock: 'Block',
    kindDocument: 'Dokument',
    kindFlow: 'Prozessablauf',
    kindList: 'Aufgabenliste',
    kindListItem: 'Listeneintrag',
    loading: 'Suche wird geladen…',
    matchCount_one: '{{count}} Fundstelle',
    matchCount_other: '{{count}} Fundstellen',
    noResults: 'Nichts gefunden für «{{query}}»',
    open: 'Prozesslandschaft durchsuchen',
  ...
  shareLink: {
    ...
    expiryMonths_other: '{{count}} Monate',
  ...
  statistics: {
    ...
    content: {
      ...
      perLocale: 'Datensätze mit einem Namen pro Sprache',
      shareLinks: 'Geteilte Links',
    ...
    orphanDelete: {
      button: 'Verwaiste Dateien löschen',
      confirmHint: 'Geben Sie {{word}} ein, um die Schaltfläche freizugeben.',
      confirmWord: 'LÖSCHEN',
      ...
      skipped_one: '1 Objekt hat eine Referenz erhalten und bleibt.',
      skipped_other: '{{count}} Objekte haben eine Referenz erhalten und bleiben.',
      summary:
    ...
    storage: {
      perCollection: 'Belegte Bytes pro Sammlung',
      publicNote:
        'Öffentliche Dokumente gehören jedem Park, deshalb haben sie keine Park-Spalte.',
    },
    technical: {
    ...
    users: {
      noPark: 'Ohne Park',
      roleAdmin: 'Super-Administratoren',
      roleUser: 'Benutzer',
      total: 'Total',
    },
  },
